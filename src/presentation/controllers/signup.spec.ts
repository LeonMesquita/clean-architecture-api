...
const makeSut = (): SutTypes => {
  ...
  const emailValidatorStup = new EmailValidatorStub()
...
// git commit -m "feat: ensure signUpController returns 400 if no email is provided"
// git commit -m "test: ensure signUpController returns 400 if no email is provided"
